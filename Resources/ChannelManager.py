...
class ChannelManager(RedisResource):
    ...
    def get_messages(self, channel_id: str) -> List[Message]:
        ...
        except (redis.ConnectionError, redis.PubSubError, redis.RedisError) as e:
            print(e)
    ...
    def update_channel_expiration(self, channel_id: str, expiration_time: timedelta = timedelta(minutes=2)) -> None:
